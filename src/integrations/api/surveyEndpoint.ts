...
export function toSurveyPayload(title: string, description: string, questions: SurveyQuestion[]): CreateSurveyRequest {
...
export function fromSurveyDto(dto: SurveyDto): { title: string; description: string; questions: SurveyQuestion[] } {
   return {
      title: dto.title,
